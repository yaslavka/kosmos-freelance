          ...
          <div  className={rootContentClasses.join` `} >
            <div  id='modal' className={cl.modalForm} onClick={e=>e.stopPropagation()}>
              ...
              <div className={cl.btnBlock}>
                ...
                <MyModalP currencyAndCount={isCurrencyAndCount} changeCurrencyAndCount={setIsCurrencyAndCount} title={`${t('private.finances.sum')}`} setVisible={setModals} visible={modals}/>
              </div>
              <br/>
              <br/>
              <div className={cl.btnBlock} onClick={(e)=>{e.preventDefault();setModales(true)}}>
                ...
                <MyModalF currencyAndCount={isCurrencyAndCounts} changeCurrencyAndCount={setIsCurrencyAndCounts} title={`${t('private.finances.sum')}`} setVisible={setModales} visible={modales}/>
              </div>
            </div>
          </div>
        </div>
